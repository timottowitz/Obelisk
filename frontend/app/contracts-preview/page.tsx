...
const stateClausesData = [
  { state: 'TX', clauseType: 'Late Payment', contractCount: 12, percentage: 75 },
  { state: 'CA', clauseType: 'Solar Rights', contractCount: 8, percentage: 50 },
  { state: 'FL', clauseType: 'Hurricane Clause', contractCount: 15, percentage: 90 },
  { state: 'NY', clauseType: 'Consumer Protection', contractCount: 6, percentage: 40 },
];
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {stateClausesData.map((clause) => (
                <div key={clause.state} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-4">
                    <Badge variant="outline">{clause.state}</Badge>
                    <div>
                      <p className="font-medium">{clause.clauseType}</p>
                      <p className="text-sm text-muted-foreground">{clause.contractCount} contracts</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <Progress value={clause.percentage} className="w-20 h-2" />
                    <span className="text-sm font-medium">{clause.percentage}%</span>
                  </div>
                </div>
              ))}
            </div>
