...
Deno.serve(async (req) => {
  ...
  switch (event.type) {
    ...
    case "organization.created": {
      ...
      await seedContactTypes(supabase, schemaName.toLowerCase());
      await seedCostTypes(supabase, schemaName.toLowerCase());
      await seedExpenseTypes(supabase, schemaName.toLowerCase());
